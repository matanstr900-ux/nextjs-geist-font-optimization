...
export default function AssembliesForm() {
  ...
  const handleInputChange = (field: keyof AssemblyFormData, value: string) => {
    setFormData(prev => ({ ...prev, [field]: value }))
  }

  const handleSubmit = () => {
    // Save to localStorage
    const existingData = JSON.parse(localStorage.getItem('assembliesData') || '[]')
    const newEntry = {
      ...formData,
    ...
    localStorage.setItem('assembliesData', JSON.stringify(existingData))
    ...
    <div className="min-h-screen p-4">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold">הרכבות</h1>
            <p className="text-gray-600">מעקב פעילות הרכבות</p>
          </div>
